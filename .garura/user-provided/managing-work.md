...
How work on Garura itself gets described, tracked, picked up, and closed. This
is the convention for this repository's issue tracker. It is loaded in every
session so that no one — human or agent — has to ask, guess, or invent one.
...
get fixed quietly "while you're in there." Note it, file it, move on.
